...
import com.explame.testtvlauncher.App;
...
//        System.out.println("UUID----->" + uuid.toString());
    ...
    public static List<String> getUserIMEI() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {//5.0以后
            String imei1 = getDeviced(App.getApplication(), 0);//第一个插槽
            String imei2 = getDeviced(App.getApplication(), 1);//第二个插槽
            if (StringUtils.isBlank(imei1) && StringUtils.isBlank(imei2)) {
                String imei3 = getimei(App.getApplication());
            ...
            String imei1 = getimei(App.getApplication());
    ...
    public static List<String> getUserIMSI() {
        List<String> list = new ArrayList<>();
        if (Build.VERSION.SDK_INT >= 21) {//5.0以后
            String sim1 = getSubscriberId(App.getApplication(), getSubId(App.getApplication(), 0));//第一个插槽
            String sim2 = getSubscriberId(App.getApplication(), getSubId(App.getApplication(), 1));//第二个插槽
            ...
            String sim1 = getimsi(App.getApplication());
            list.add(sim1);
        }
        return list;
    }
    ...
    public static String getUniqueDeviceID(Context context) {
        ...
        try {
            ...
            filePath1 = App.getApplication().getFilesDir() + File.separator + "SADeviceID" + File.separator + "7e8e9e123456.txt";
