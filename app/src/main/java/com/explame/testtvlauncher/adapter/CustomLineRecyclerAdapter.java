...
public class CustomLineRecyclerAdapter extends CustomLineRecyclerView.CustomAdapter<Integer> {

    public CustomLineRecyclerAdapter(Context context, List<Integer> data) {
        super(context, data);
    }
    ...
    protected void onSetItemData(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        holder.tv_focus.setText("Line:" + position);
    }
